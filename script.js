...
let block1_item = document.querySelector(".block1_item");
let wrapperGrid = document.querySelector(".wrapperGrid");
...
let menu__li = document.querySelector(".menu__li");
let arrow = document.querySelector(".arrow");
let item_store = document.querySelector(".item_store");
let item_store2 = document.querySelector(".item_store2");
let item_store3 = document.querySelector(".item_store3");

if (menu__li) {
	menu__li.addEventListener("click", function () {
		menu__li.classList.toggle("active");
		arrow.classList.toggle("active");
		item_store.classList.toggle("active");
		item_store2.classList.toggle("active");
		item_store3.classList.toggle("active");
	});
}